        ...
        h = function(r) {
            if (i[r] !== t) {
                ...
                if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && i[r].c.css({
                    ...
                    i[r].c.height(O.height), 0 === i[r].c.find("rs-progress").length && i[r].c.append('<rs-progress style="visibility:hidden"></rs-progress>'), i[r].c.find("rs-progress").css({
                        width: "0%"
                    }), i[r].canvas.css({
                        display: "block"
            ...
            i[r].c.on("stoptimer", function() {
                ...
                if (!i[r].forcepaused) {
                    ...
                    1 === i[r].noloopanymore || i[r].viewPort.enable && !i[r].inviewport || 1 == i[r].ssop || (t.css({
                        ...
                        visibility: "hidden"
                    }), i.toggleState(i[r].slidertoggledby), i[r].mouseoncontainer && 1 == i[r].navigation.onHoverStop && !a && (i[r].c.trigger("stoptimer"), i[r].c.trigger("revolution.slide.onpause"))
                }
            ...
            for (var n in i[o]._L = void 0 === i[o]._L ? {} : i[o]._L, i[o].layers[s])
                if (i[o].layers[s].hasOwnProperty(n)) {
                    ...
                    if (void 0 === i.gA(c, "initialised")) {
                        ...
                        g.textalign = u(g.textalign), g.vbility = i.revToResp(g.vbility, i[o].rle, !0), g.hoffset = i.revToResp(g.hoffset, i[o].rle, 0), g.voffset = i.revToResp(g.voffset, i[o].rle, 0), g.x = i.revToResp(g.x, i[o].rle, "l"), g.y = i.revToResp(g.y, i[o].rle, "t"), T(h, 0, o), i.sA(c, "initialised", !0)
                    }
                        ...
                        if (0 == g.vbility[i[o].levelForced] || "f" == g.vbility[i[o].levelForced] || m < i[o].hideLayerAtLimit && "on" == g.layeronlimit || m < i[o].hideAllLayerAtLimit ? g.p[0].classList.add("rs-layer-hidden") : g.p[0].classList.remove("rs-layer-hidden"), g.poster = null == g.poster && void 0 !== g.thumbimage ? g.thumbimage : g.poster, "image" === g.layertype)
                            if ("cover-proportional" === g.img.data("c")) {
                                ...
                                var k = "auto" !== g.width[i[o].level] || isNaN(g.width[i[o].level]) && g.width[i[o].level].indexOf("%") >= 0 ? "100%" : "auto",
                                    R = "auto" !== g.height[i[o].level] || isNaN(g.height[i[o].level]) && g.height[i[o].level].indexOf("%") >= 0 ? "100%" : "auto";
                                punchgs.TweenMax.set(g.img, {
                                    width: k,
                                    height: R
                                })
                            ...
                            if (g._incolumn && "100%" === z && "auto" === O && void 0 !== g.ytid) {
                                ...
                                width: z,
                                height: O
                            }), (0 == g.html5vid && !A || 1 != g.forcecover && !h.hasClass("rs-fsv") && !A) && (g.media.width(z), g.media.height(O)), g._ingroup && null != z && !jQuery.isNumeric(z) && z.indexOf("%") > 0 && punchgs.TweenMax.set([g.lp, g.p, g.m], {
                                minWidth: z
                            })
                        }
                        g._slidelink || I(h, o, 0, g.rsp_bd), "on" === g.rsp_ch && "row" !== g.type && "column" !== g.type && "group" !== g.type && h.find("*").each(function() {
                            var e = jQuery(this);
                            "true" !== i.gA(this, "stylerecorder") && !0 !== i.gA(this, "stylerecorder") && T(e, "rekursive", o), I(e, o, "rekursive", g.rsp_bd)
                        })
                    }
                    if ("preset" !== e.mode) {
                        ...
                        }), void 0 !== g.frames.loop && punchgs.TweenMax.set(g.lp, {
                            width: g.eow,
                            height: g.eoh
                        ...
                        if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                            ...
                            if ("frame_999" !== I || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                ...
                                var A = u.frames[I],
                                    ...
                                    W = H.ease;
                                "block" === P.type && (P.ft[0].background = A.sfx.fxc, O.add(punchgs.TweenMax.fromTo(P.bmask_in, j / 2, P.ft[0], P.ft[1], 0)), O.add(punchgs.TweenMax.fromTo(P.bmask_in, j / 2, P.ft[1], P.t, j / 2)), "frame_0" === I || "frame_1" === I ? N.opacity = 0 : "frame_999" === I && O.add(M.staggerFromTo(C, .05, {
                                    autoAlpha: 1
                                }, {
                                    autoAlpha: 0,
                                    delay: j / 2
                                ...
                                if (void 0 !== u.splitText && !1 !== u.splitText)
                                    for (var F in t)
                                        if (void 0 === A[t[F]] || u.quickRendering) u.fff ? O.add(M.fromTo(u.splitText[t[F]], j, {
                                            immediateRender: !1,
                                            color: N.color
                                        }, {
                                            color: H.color
                                        }, 0), 0) : O.add(M.to(u.splitText[t[F]], j, {
                                            color: H.color
                                        }, 0), 0);
                                        else {
                                            ...
                                            delete Z.dir, Z.data = {
                                                splitted: !0
                                            }, void 0 !== q && delete q.dir, u.fff ? O.add(M.staggerFromTo(V, j, q, Z, u.frames[I].split ? Q : 0, 0), 0) : O.add(M.staggerTo(V, j, Z, u.frames[I].split ? Q : 0, 0), 0), Y = V.length > Y ? V.length : Y
                                        }
                                j += u.frames[I].split ? Q * Y : 0, u.pxundermask || void 0 !== B && (void 0 !== z && "hidden" === z.mask.overflow || "hidden" === A.mask.overflow) ? (O.add(punchgs.TweenMax.to(u.m, .001, {
                                    overflow: "hidden"
                                }), 0), "column" === u.type && O.add(punchgs.TweenMax.to(u.cbgmask, .001, {
                                    overflow: "hidden"
                                }), 0), u.btrans && (D && (D.rotationX = u.btrans.rX, D.rotationY = u.btrans.rY, D.rotationZ = u.btrans.rZ, D.opacity = u.btrans.o), B.rotationX = u.btrans.rX, B.rotationY = u.btrans.rY, B.rotationZ = u.btrans.rZ, B.opacity = u.btrans.o), u.fff ? O.add(punchgs.TweenMax.fromTo([u.m, u.cbgmask], j, jQuery.extend(!0, {}, D), jQuery.extend(!0, {}, B)), .001) : O.add(punchgs.TweenMax.to([u.m, u.cbgmask], j, jQuery.extend(!0, {}, B)), .001)) : void 0 !== u.btrans ? O.add(punchgs.TweenMax.to(u.m, .001, {
                                    x: 0,
                                    y: 0,
                                    filter: "none",
                                    opacity: u.btrans.o,
                ...
                if (S || (u.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? e.frame : u.lastRequestedMainFrame), void 0 !== e.totime ? u.tSTART = e.totime : void 0 !== f && void 0 === e.frame ? u.tSTART = f : void 0 !== e.frame ? u.tSTART = e.frame : u.tSTART = 0, 0 === u.tSTART && void 0 === u.startedAnimOnce && void 0 === u.leftstage && void 0 === u.startedAnimOnce && !0 === u.hideonfirststart && "preset" === e.mode && (i[c]._L[d[0].id].p[0].classList.add("rs-forcehidden"), u.hideonfirststart = !1), "frame_999" !== u.tSTART && "frame_999" !== u.triggeredFrame || !u.leftstage && void 0 !== u.startedAnimOnce) {
                    if ("true" != u.animationonscroll && 1 != u.animationonscroll ? u.timeline.play(u.tSTART) : u.timeline.time(u.tSTART), jQuery.inArray(u.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        if (void 0 === u.childrenJS)
                            for (var F in u.childrenJS = {}, i[c]._L) void 0 !== i[c]._L[F]._lig && void 0 !== i[c]._L[F]._lig[0] && i[c]._L[F]._lig[0].id === d[0].id && i[c]._L[F]._lig[0].id !== i[c]._L[F].c[0].id && (u.childrenJS[i[c]._L[F].c[0].id] = i[c]._L[F].c);
                        ...
                        if (!0 === e.updateChildren)
                            for (var F in u.childrenJS) u.childrenJS.hasOwnProperty(F) && i.renderLayerAnimation({
                            ...
                            for (var F in u.childrenJS) u.childrenJS.hasOwnProperty(F) && i[c]._L[F].pausedTrueParrent && (i.renderLayerAnimation({
                                layer: u.childrenJS[F],
                                fastforward: !1,
                                id: c,
                                mode: "continue",
        ...
        I = function(e, t, a, r) {
            ...
            if ("column" === o.type && punchgs.TweenMax.set(o._column, {
                ...
                if (o._incolumn || (m.marginTop = "row" === o.type ? 0 : g.t * h + "px", m.marginBottom = "row" === o.type ? 0 : g.b * h + "px", m.marginLeft = "row" === o.type ? 0 : g.l * u + "px", m.marginRight = "row" === o.type ? 0 : g.r * u + "px"), void 0 !== o.spike && (m["clip-path"] = m["-webkit-clip-path"] = o.spike), p.boxShadow && (m.boxShadow = p.boxShadow), "column" !== o.type && (void 0 !== p.borderStyle && "none" !== p.borderStyle && (0 !== p.borderTopWidth || p.borderBottomWidth > 0 || p.borderLeftWidth > 0 || p.borderRightWidth > 0) ? (m.borderTopWidth = Math.round(p.borderTopWidth * h) + "px", m.borderBottomWidth = Math.round(p.borderBottomWidth * h) + "px", m.borderLeftWidth = Math.round(p.borderLeftWidth * u) + "px", m.borderRightWidth = Math.round(p.borderRightWidth * u) + "px", m.borderStyle = p.borderStyle, m.borderTopColor = p.borderTopColor, m.borderBottomColor = p.borderBottomColor, m.borderLeftColor = p.borderLeftColor, m.borderRightColor = p.borderRightColor) : ("none" === p.borderStyle && (m.borderStyle = "none"), m.borderTopColor = p.borderTopColor, m.borderBottomColor = p.borderBottomColor, m.borderLeftColor = p.borderLeftColor, m.borderRightColor = p.borderRightColor)), "shape" !== o.type && "image" !== o.type || 0 === p.borderTopLeftRadius && 0 === p.borderTopRightRadius && 0 === p.borderBottomLeftRadius && 0 === p.borderBottomRightRadius || (m.overflow = "hidden"), o._isnotext || ("column" !== o.type && (m.fontSize = Math.round(p.fontSize * u) + "px", m.fontWeight = p.fontWeight, m.letterSpacing = p.letterSpacing * u + "px", p.textShadow && (m.textShadow = p.textShadow), p.textStroke && (m["-webkit-text-stroke"] = p.textStroke)), m.lineHeight = Math.round(p.lineHeight * h) + "px", m.textAlign = p.textAlign), "column" === o.type && (void 0 === o.cbg_set && (o.cbg_set = o.styleProps["background-color"], o.cbg_set = "" == o.cbg_set || void 0 === o.cbg_set || 0 == o.cbg_set.length ? "transparent" : o.cbg_set, o.cbg_img = e.css("backgroundImage"), o.cbg_img_r = e.css("backgroundRepeat"), o.cbg_img_p = e.css("backgroundPosition"), o.cbg_img_s = e.css("backgroundSize"), o.cbg_o = o.bgopacity ? 1 : o.bgopacity, punchgs.TweenMax.set(e, {
                        ...
                        backgroundImage: ""
                    })), m.backgroundColor = "transparent", m.backgroundImage = "none"), o._isstatic && o.elementHovered && (n = e.data("frames")) && n.frame_hover && n.frame_hover.transform)
                    for (l in m) m.hasOwnProperty(l) && n.frame_hover.transform.hasOwnProperty(l) && delete m[l];
                if ("IFRAME" == e[0].nodeName && "html" === i.gA(e[0], "layertype") && (d = "slide" == p.basealign ? i[t].ulw : i[t].gridwidth[i[t].level], c = "slide" == p.basealign ? i[t].ulh : i[t].gridheight[i[t].level], m.width = !jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.width : d * parseInt(p.width, 0) / 100 : R(p.width, u, "auto", d, "auto"), m.height = !jQuery.isNumeric(p.height) && p.height.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.height : c * parseInt(p.height, 0) / 100 : R(p.height, h, "auto", d, "auto")), punchgs.TweenMax.set(e, m), "rekursive" != a) {
                    ...
                    var v = !jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.width : d * parseInt(p.width, 0) / 100 : R(p.width, u, "auto", d, "auto"),
                        y = !jQuery.isNumeric(p.height) && p.height.indexOf("%") >= 0 ? !o._isstatic || o._incolumn || o._ingroup ? p.height : c * parseInt(p.height, 0) / 100 : R(p.height, h, "auto", d, "auto"),
                        b = {
                    ...
                    if (1 == o.heightSetByVideo && delete b.height, o._incolumn ? (punchgs.TweenMax.set([o.p], {
                            ...
                            width: "100%"
                        }), b.width = !jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0 ? "100%" : v, "image" === o.type && punchgs.TweenMax.set(o.img, {
                            width: b.width
                        })) : !jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0 && (punchgs.TweenMax.set([o.p], {
                            minWidth: "slide" === o.basealign || !0 === o._ingroup ? v : i[t].gridwidth[i[t].level] * i[t].bw + "px"
                        }), punchgs.TweenMax.set([o.lp, o.m], {
                            width: "100%"
                        })), !jQuery.isNumeric(p.height) && p.height.indexOf("%") >= 0 && (punchgs.TweenMax.set([o.p], {
                            minHeight: "slide" === o.basealign || !0 === o._ingroup ? y : i[t].gridheight[i[t].level] * i[t].bw + "px"
                        }), punchgs.TweenMax.set([o.lp, o.m], {
                            height: "100%"
                        })), o._isnotext || (b.whiteSpace = p.whiteSpace, b.textAlign = p.textAlign, b.textDecoration = p.textDecoration), "npc" != p.color && void 0 !== p.color && (b.color = p.color), o._ingroup && (o._groupw = b.minWidth, o._grouph = b.minHeight), "row" === o.type && (jQuery.isNumeric(b.minHeight) || b.minHeight.indexOf("px") >= 0) && "0px" !== b.minHeight && 0 !== b.minHeight && "0" !== b.minHeight && "none" !== b.minHeight ? b.height = b.minHeight : "row" === o.type && (b.height = "auto"), o._isstatic && o.elementHovered && (n = e.data("frames")) && n.frame_hover && n.frame_hover.transform)
                        for (l in b) b.hasOwnProperty(l) && n.frame_hover.transform.hasOwnProperty(l) && delete b[l];
                    "image" === o.type && (!jQuery.isNumeric(b.width) && b.width.indexOf("%") >= 0 && (b.width = "100%"), !jQuery.isNumeric(b.height) && b.height.indexOf("%") >= 0 && (b.height = "100%")), o._isgroup && (!jQuery.isNumeric(b.width) && b.width.indexOf("%") >= 0 && (b.width = "100%"), punchgs.TweenMax.set(o.p, {
                        height: b.height
                    })), punchgs.TweenMax.set(e, b), null != o.svg_src && void 0 !== o.svgI && ("string" == typeof o.svgI.fill && (o.svgI.fill = [o.svgI.fill]), o.svgTemp = jQuery.extend(!0, {}, o.svgI), o.svgTemp.fill = o.svgTemp.fill[i[t].level], punchgs.TweenMax.set(o.svg, o.svgTemp), punchgs.TweenMax.set(o.svgPath, {
                    ...
                    if ("carousel" === t[a].sliderType && (("move" === s || "end" === s || "cancel" == s) && t[a].dragStartedOverSlider && !t[a].dragStartedOverThumbs && !t[a].dragStartedOverTabs || "start" === s && g > 0 && 0 === f && 0 === m)) {
                        ...
                        switch (s) {
                            ...
                            case "move":
                                ...
                                O = O < M ? "horizontal" === R ? O + L.width() * (O - M) / L.width() * (O - M) / L.width() : O + L.height() * (O - M) / L.height() * (O - M) / L.height() : O, "vertical" === R ? punchgs.TweenLite.set(L, {
                                    top: O + "px"
            ...
            if (void 0 !== t[e]) {
                ...
                if (_.set && (!_.mobile || !i)) {
                    ...
                    if (!1 !== _.bgs) {
                        ...
                        for (var S in "top" == _.direction && c >= 0 && (k = 1), "bottom" == _.direction && c <= 0 && (k = 1), k = k > 1 ? 1 : k < 0 ? 0 : k, _.bgs)
